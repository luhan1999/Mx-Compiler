...
import static Mx.ir.IRBinaryOperation.IRBinaryOp.*;
public class IRBinaryOperation extends IRInstruction{
    ...
    @Override
    public IRRegister getDefinedRegister() { return dest; }

    @Override
    public void setDefinedRegister(IRRegister vreg) { dest = vreg; }

    public void accept(IRVisitor visitor) { visitor.visit(this);}

    public IRBinaryOp getOp() { return op; }

    public IRRegister getDest() { return dest; }
