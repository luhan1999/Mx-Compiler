...
public abstract class IRInstruction {
    ...
    public void setPrevInst(IRInstruction prevInst) {this.prevInst = prevInst;}
    public void setNextInst(IRInstruction nextInst) {this.nextInst = nextInst;}

    public void remove(){
        if(removed) {
            throw new CompilerError("The instruction has beed removed, cannot be removed again");
        }
        removed = true;
    ...
    public void replace(IRInstruction inst){
        if(removed){
            throw new CompilerError("cannot remove an removed instruction");
        }
        removed = true;
    ...
    public IRInstruction getPrevInst() { return prevInst; }
    public IRInstruction getNextInst() { return nextInst; }
    public BasicBlock getParentBB() { return parentBB; }
