...
public class StaticUsagePreScanner extends BaseScopeScanner{
    ...
    public StaticUsagePreScanner(Scope globalScope) { this.globalScope = globalScope; }
    ...
    @Override
    public void visit(VarDeclListNode node) { super.visit(node); }

    @Override
    public void visit(FuncDeclNode node) { node.getBody().accept(this); }

    @Override
    public void visit(ClassDeclNode node) { super.visit(node); }
