...
public class IRBuilder extends BaseScopeScanner{
    ...
    public void visit(ProgramNode node){
        ...
        //pre-scanning for functions && class.functions
    ...
    public void visit(WhileStmtNode node){
        ...
        BasicBlock externalLoopCondBB = currentLoopStepBB;
        BasicBlock externalLoopAfterBB = currentLoopAfterBB;
    ...
    // A && B  we can take A false as false, A true jump B
    // A || B  we can take A true  as true,  A false jump B
    ...
    @Override
    public void visit(BoolConstExprNode node) { node.setRegValue(new IntImmediate(node.getValue() ? 1 : 0)); }

    @Override
    public void visit(NullExprNode node) { node.setRegValue(new IntImmediate(0)); }
